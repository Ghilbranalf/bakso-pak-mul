        ...
        <div className="w-full lg:w-7/12 flex items-center justify-center p-6 md:p-12 lg:p-20 bg-surface-white">
          <div className="w-full max-w-[440px]">
            ...
            <div className="mb-10 hidden lg:block">
              <h2 className="text-3xl text-on-surface font-bold">Daftar Akun Baru</h2>
              <p className="text-base text-on-surface-variant mt-3">Silakan lengkapi informasi berikut untuk memulai.</p>
            </div>

            <form className="space-y-5" action={signup}>
              {/* Name Field */}
              <div className="space-y-1.5">
                <label className="text-sm font-semibold text-on-surface/80 block" htmlFor="name">Nama Lengkap</label>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-red-800">
                        {searchParams.message === '{}' ? 'Terjadi kesalahan. Silakan coba lagi.' : searchParams.message}
                      </h3>
                    </div>
                  </div>
                </div>
